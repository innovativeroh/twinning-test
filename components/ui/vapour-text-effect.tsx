...
export const Component = () => {
    return (
        <div className='w-full mt-[-30px] mb-[-20px] justify-center items-center'>
            <VaporizeTextCycle
                texts={["Smarter Ad Targeting Strategies", "Instant Customer Intelligence", "Maximum ROI with AI"]}
                font={{
